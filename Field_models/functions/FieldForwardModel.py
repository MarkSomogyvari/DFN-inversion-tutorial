...
#    theta = [0,theta1,theta2]
    ...
    for i in range(0,np.shape(DFN_Coord_File)[0]):
        Frac_Seg_Mat[i,:] = [DFN_Coord_File[i,4], DFN_Coord_File[i,0], DFN_Coord_File[i,1], DFN_Coord_File[i,2], DFN_Coord_File[i,3],
                     DFN_Coord_File[i,0] - DFN_Coord_File[i,2]/2*np.cos(DFN_Coord_File[i,3]), DFN_Coord_File[i,1] - DFN_Coord_File[i,2]/2*np.sin(DFN_Coord_File[i,3]),
                     DFN_Coord_File[i,0] + DFN_Coord_File[i,2]/2*np.cos(DFN_Coord_File[i,3]), DFN_Coord_File[i,1] + DFN_Coord_File[i,2]/2*np.sin(DFN_Coord_File[i,3])]
    ...
    ninj = 0
    nprod = 0
    Inj_id = np.zeros(np.sum(SR_coord[:,0]==1))
    Prod_id = np.zeros(np.sum(SR_coord[:,0]==-1))
